...
export class AuthService {
  ...
  public async register(req: Request, dto: RegisterDto) {
    ...
    if (isExists) {
      throw new ConflictException(
        `Регистрация не удалась. Пользователь с таким email уже существует. 
         Пожалуйст, используйте другой email или войдите в систему.`
      )
    }
    ...
    return {
      message: `Вы успешно зарегистрировались. Пожалуйста, подтвердите ваш email. Сообщение было отправлено на ваш почтоый адрес.`
    }
  }
